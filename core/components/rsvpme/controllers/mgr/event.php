 ...
 */
/**
 * Loads the Event edition page
 *
 * @package rsvpme
 * @subpackage controllers
 */
$modx->regClientStartupScript($modx->getOption('manager_url').'assets/modext/util/datetime.js');
$modx->regClientStartupScript($RSVPMe->config['jsUrl'].'mgr/widgets/registered.grid.js');
$modx->regClientStartupScript($RSVPMe->config['jsUrl'].'mgr/widgets/event.panel.js');
$modx->regClientStartupScript($RSVPMe->config['jsUrl'].'mgr/sections/event.js');
$output = '<div id="rsvpme-panel-event-div"></div>';
